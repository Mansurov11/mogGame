...
export default function WordSnake() {
  ...
  if (screen === "menu") {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br ${sk.bg} flex flex-col font-sans select-none`}
      >
        <button
          onClick={() => navigate("/")}
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-8">
          ...
          <div
            className={`bg-gray-900 border ${sk.border} border-opacity-40 rounded-2xl p-6 w-full max-w-sm shadow-2xl`}
          >
  ...
  if (screen === "game") {
    ...
    return (
      <div
        className={`min-h-screen bg-linear-to-br ${sk.bg} flex flex-col items-center justify-start pt-3 pb-6 px-2 select-none`}
      >
        {/* HUD */}
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 px-1">
            ...
            <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
              <div className="text-center">
                ...
                <div className="text-white/60 font-black text-lg">
                  {bestScore}
                </div>
              </div>
              <div className="text-center">
                ...
                <div className={`text-white font-black text-lg ${sk.tag}`}>
                  {g2?.score ?? 0}
                </div>
              </div>
              <div className="text-center">
                ...
                <div className={`font-black text-lg ${sk.tag}`}>
                  ×{speedLevel}
                </div>
              </div>
              <button
        ...
        {g2 && (
          <div
            className={`w-full max-w-2xl bg-gray-900 rounded-xl p-3 mb-2 border ${sk.border} border-opacity-30`}
          >
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              <span className="text-gray-400 text-xs uppercase tracking-widest shrink-0">
                Spell:
              </span>
        ...
        {wordComplete && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-10 px-4">
            <div
              className={`bg-gray-900 border-2 ${sk.border} rounded-2xl p-8 text-center shadow-2xl w-full max-w-xs`}
            >
        ...
        {g2 && !g2.alive && !wordComplete && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/80 backdrop-blur-sm z-10 px-4">
            ...
            >
              ...
              <div className={`text-4xl font-black ${sk.tag} mb-2`}>
                {g2.score} pts
              </div>
              ...
              <div className="flex gap-3 justify-center">
                <button
                  ...
                  className={`${sk.btn} w-90 text-white font-black px-6 py-3 rounded-xl shadow-lg transition-all active:scale-95`}
                >
                  Menu
                </button>
              </div>
